...
public class MediaController extends FrameLayout {
     ...
     * @param time
     */
    public void setDefaultShowTime(int time){
    	if(time <=0 ) return;
    	
    	sDefaultTimeout = time*1000;
    }    
    ...
    public interface OnPlayPositionListener{
    	public void onPlayPosition(int currentPosition, int duration);
    }
    
    private OnPlayPositionListener mPlayPositionListener;
    
    public void setOnPlayPositionListener(OnPlayPositionListener l){
    	mPlayPositionListener = l;
    }
    ...
    private long setProgress() {
        ...
        if(mPlayPositionListener != null){
        	mPlayPositionListener.onPlayPosition(position, duration);
        }
